...
export const INITIAL_PRODUCTS: ProductItem[] = [
  {
    ...
    sourceUrl: 'https://www.fashionnetwork.com/news/Chanel-boosts-n-1-de-chanel-skincare-range,1478201.html',
    sourceName: 'FashionNetwork France (공식)',
    reliability: '공식 발표',
    importance: '높음',
    importanceScore: 9,
    scoreDetails: {
  ...
  },
  {
    ...
    sourceUrl: 'https://www.lefigaro.fr/langue-francaise',
    sourceName: 'Le Figaro Madame (기사)',
    reliability: '언론 보도',
    importance: '높음',
    importanceScore: 8,
    scoreDetails: {
  ...
  },
  {
    ...
    sourceName: 'Les Échos Tech (공식보도)',
    reliability: '공식 발표',
    importance: '높음',
    importanceScore: 7,
    scoreDetails: {
